...
const docTemplate = `{
    ...
    "paths": {
        "/api/auth/rso/callback": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "RSO authorization code",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.RSORequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.RSOCallbackResponse"
                        }
                    },
                    "400": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.BillingPlansResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.InviteStackMemberRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.StackMembersResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
        ...
        "/api/billing/stack/members/{id}": {
            "delete": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Stack member record ID",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.StripeWebhookResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/lobbies/{code}": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Canvas update request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.UpdateLobbyRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/strategies": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Create strategy request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.CreateStrategyRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/strategies/{id}": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Update strategy request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.UpdateStrategyRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.UpdateUserSubscriptionRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        "handlers.BillingPlanPriceResponse": {
            "type": "object",
            "properties": {
                "currency": {
                    "type": "string"
        ...
        "handlers.BillingPlansResponse": {
            "type": "object",
            "properties": {
                "monthly": {
                    "$ref": "#/definitions/handlers.BillingPlanPriceResponse"
                },
                "stack": {
                    "$ref": "#/definitions/handlers.BillingPlanPriceResponse"
                },
        ...
        "handlers.InviteStackMemberRequest": {
            "type": "object",
            "properties": {
                "firebaseUid": {
                    "type": "string"
        ...
        "handlers.StripeWebhookResponse": {
            "type": "object",
            "properties": {
                "eventId": {
                    "type": "string"
        ...
        "handlers.UpdateLobbyRequest": {
            "type": "object",
            "properties": {
                "canvasState": {
                    "$ref": "#/definitions/models.FullCanvasState"
                }
            }
        },
        ...
        "handlers.UpdateUserSubscriptionRequest": {
            "type": "object",
            "properties": {
                "firebaseUid": {
                    "type": "string"
        ...
        "handlers.metricsResponse": {
            ...
            "properties": {
                "canvas_patch": {
                    "$ref": "#/definitions/handlers.canvasPatchMetrics"
                },
                "db": {
                    "$ref": "#/definitions/handlers.dbMetrics"
                },
                "goroutines": {
                    "type": "integer"
                },
                "lobbies": {
                    "$ref": "#/definitions/handlers.lobbyMetrics"
                },
                "memory": {
                    "$ref": "#/definitions/handlers.memoryMetrics"
                },
                "rate_limiter": {
                    "$ref": "#/definitions/handlers.rateLimiterMetrics"
                },
                "stripe_webhook": {
                    "$ref": "#/definitions/handlers.stripeWebhookMetrics"
                },
                "uptime_seconds": {
                    "type": "number"
                },
                "websocket": {
                    "$ref": "#/definitions/websocket.HubStats"
                }
            }
        },
        "handlers.rateLimiterMetrics": {
            "type": "object",
            "properties": {
                "rejections": {
                    "type": "integer"
        ...
        "models.FullCanvasState": {
            "type": "object",
            "properties": {
                "abilitiesSettings": {
                    "$ref": "#/definitions/models.IconSettings"
                },
                "agentsSettings": {
                    "$ref": "#/definitions/models.IconSettings"
                },
                ...
                "phases": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.PhaseState"
                    }
                },
                "selectedMap": {
                    "$ref": "#/definitions/models.MapOption"
                }
            }
        },
        "models.IconSettings": {
        ...
        "models.PhaseState": {
            ...
            "properties": {
                "abilitiesOnCanvas": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.CanvasAbility"
                    }
                },
                "agentsOnCanvas": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.CanvasAgent"
                    }
                },
                "connectingLines": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.CanvasConnectingLine"
                    }
                },
                "drawLines": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.CanvasDrawLine"
                    }
                },
                "imagesOnCanvas": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.CanvasImage"
                    }
                },
                "textsOnCanvas": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.CanvasText"
                    }
                },
                "toolIconsOnCanvas": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.CanvasToolIcon"
                    }
                }
            }
        },
        ...
        "models.StackMember": {
            ...
            "properties": {
                ...
                "memberEmail": {
                    "description": "Populated via JOIN when listing members",
                    "type": "string"
                },
                "memberName": {
                    "type": "string"
